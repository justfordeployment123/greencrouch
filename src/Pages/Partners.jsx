...
const Partners = () => {
  ...
  return (
    <section>
      {/* Desktop View */}
      <div className="relative flex-col hidden px-20 py-12 md:flex">
        {/* Network & streamers */}
      ...
      {/* Mobile View */}
      <div className="relative flex flex-col px-2 py-16 space-y-12 md:hidden sm:px-4">
        <div
        ...
        <div className="relative z-10">
          <h2 className="mb-12 text-3xl font-semibold text-center text-white sm:text-4xl">
